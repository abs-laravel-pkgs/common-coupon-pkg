...
<script type="text/javascript">
    var coupon_list_template_url = "{{asset($common_coupon_pkg_prefix.'/public/themes/'.$theme.'/common-coupon-pkg/coupon/list.html')}}";
    var coupon_form_template_url = "{{asset($common_coupon_pkg_prefix.'/public/themes/'.$theme.'/common-coupon-pkg/coupon/form.html')}}";
</script>
